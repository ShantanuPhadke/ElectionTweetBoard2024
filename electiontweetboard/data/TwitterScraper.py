		...
		while True:
			...
			try:
				with multiprocessing.Pool(1) as pool:
					...
					result = pool.apply_async(TwitterScraper.scraper.get_tweets, args=(query_string), kwds={'mode': 'term', 'number': number_tweets, 'near': near, 'language': 'en'})
					results_dict = result.get(300)
